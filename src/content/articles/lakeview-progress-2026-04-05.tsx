  ...
  return (
    <>
      <p className="text-lg text-text-secondary leading-relaxed mb-6">
        У квітні–травні 2026 року{' '}
        <Link to="/portfolio/lakeview" className="text-accent hover:underline">
          ЖК Lakeview
        </Link>{' '}
        пройшов три планові позиції графіка. Забудовник отримав і оплатив
        технічні умови на електропостачання, відкрив фасадні роботи на першій
        секції та розпочав улаштування інверсійної покрівлі. Усе це вписується
      ...
      <p className="mb-6 leading-relaxed">
        ...
        Виконання технічних умов є обов'язковим і нескорочуваним етапом: без нього
      ...
      <p className="mb-6 leading-relaxed">
        ...
        пошкоджень, що суттєво збільшує строк служби покрівлі. За умови
        дотримання технології він сягає 40–50 років.
      </p>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        з об'єктами СС1–СС2. Для покупця СС3 є конкретним правовим інструментом
      ...
      <p className="mb-6 leading-relaxed">
        Три етапи квітня–травня складають єдину послідовність, що веде до здачі
        об'єкта у <strong>2027 році</strong>.
      ...
      <p className="mb-6 leading-relaxed">
        Клас СС3 означає, що будь-який відступ від проєктних параметрів, навіть
        незначний, потребує оформлення і не може бути прихований: усі виявлені
        відхилення відображаються в журналі авторського нагляду.
      </p>
