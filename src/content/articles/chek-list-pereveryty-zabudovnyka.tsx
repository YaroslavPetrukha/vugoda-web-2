  ...
  return (
    <>
      <p className="text-lg text-text-secondary leading-relaxed mb-6">
        Купівля квартири в новобудові в Україні — це угода з юридичною особою,
        яка ще не завершила свій продукт. Ви платите зараз, а отримуєте ключі
        через рік-два. Такий розрив у часі між оплатою і результатом породжує
        специфічні ризики: забудовник може збанкрутувати, затягнути будівництво
        або виявитися нелегітимним. Цей чек-лист допоможе перевірити будь-якого
        забудовника за 8 пунктами — більшість з них займають від 10 до 30 хвилин
        кожен. Разом — від 1,5 до 2 годин роботи, які можуть зберегти роки судів
        і заморожений капітал.
      </p>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        молодша двох років без жодного завершеного об'єкта — підвищений ризик.
      ...
      <p className="mb-6 leading-relaxed">
        ...
        . Будь-яке будівництво без ДВРБ — позаправове, незалежно від красивого
      ...
      <p className="mb-6 leading-relaxed">
        ...
        рішення. Цегляна технологія — добра тепло- і звукоізоляція, але
        найповільніша і найдорожча. Перевірте, яка технологія задекларована в
      ...
      <p className="mb-6 leading-relaxed">
        Червоні прапори у фінансових умовах: знижки -30–50% без зрозумілого
        обґрунтування (ознака або перегрітої базової ціни, або фінансових
        труднощів), схеми «купуй зараз, плати потім без жодних відсотків»
        (приховані витрати або перекладання ризику), вимога 100% передоплати на
        стадії котловану без будь-яких гарантій. Надійний забудовник зацікавлений
        у поступовому грошовому потоці — повна передоплата на ранній стадії в
        його інтересах, але не у ваших.
      </p>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        оформлюється як продаж майнових прав, а не самої квартири — оскільки
        об'єкт нерухомості ще не введений в експлуатацію і не має кадастрового
        номера. Договір купівлі-продажу майнових прав — легітимний інструмент,
      ...
      <p className="mb-6 leading-relaxed">
        ...
        переуступка майнових прав від попереднього покупця — законна, але
        ...
        інструментів — привід звернутися до незалежного юриста перед
        підписанням.
      </p>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        строків і санкцій — конкретний ризик, а не формальність.
      </p>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        Найнадійніший — особистий візит на майданчик. Активне будівництво видно
      ...
      <p className="mb-6 leading-relaxed">
        ...
        Зверніть увагу на дати публікацій: якщо останні матеріали датовані
        шістьма місяцями тому, а будинок «повинен здатися через рік» —
        невідповідність потребує пояснення. Регулярна і датована документація
      ...
      <p className="mb-6 leading-relaxed">
        ...
        мешканці. Для пошуку відгуків використовуйте тематичні форуми — зокрема{' '}
        <a
          href="https://lun.ua/"
          target="_blank"
          rel="noopener noreferrer"
      ...
      <p className="mb-6 leading-relaxed">
        ...
        субпідрядниками — підстава для детального вивчення обставин. Також
      ...
      <p className="mb-6 leading-relaxed">
        Методологія у деталях — на сторінці{' '}
        <Link to="/pidkhid" className="text-accent hover:underline">
          наш підхід
        </Link>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        Вісім пунктів перекривають основні вектори ризику: легітимність
        компанії, законність будівництва, якість юридичного захисту і фінансову
        стійкість схеми. Більшість перевірок виконується безкоштовно через
        державні реєстри онлайн.
      </p>

      <p className="mb-6 leading-relaxed">
        Цей чек-лист універсальний — застосовуйте його до будь-якого
        забудовника, не лише до ВИГОДА. Якщо компанія відмовляється надати
        ЄДРПОУ, посилання на дозвіл у реєстрі або проект договору до підписання
        — це достатня відповідь на питання, чи варто далі витрачати час.
      </p>
    </>
  );
}
