...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Забудовник ЖК Lakeview — ПП «ДІК "Вигода +"», ЄДРПОУ 44876801, заснована 2019 року. Будує житлові та нежитлові будівлі як забудовник — без підрядних посередників. Юридичні документи, статут і дозвільна документація надаються на запит до підписання договору. Офіс продажу — вул. Володимира Великого, 4, поверх 4, кабінет 406, за 200 метрів від будмайданчика.',
  },
  {
