...
export const meta: MetaFunction = ({ location }) => {
  const title = 'PILOT · Investoram Hero Preview';
  const description = 'Preview pilot v4-style hero для /investoram — НЕ для production.';
...
const PilotInvestors = () => {
  return (
    <>
      <div className="bg-accent text-bg-deep px-6 py-2 text-center text-xs font-mono tracking-widest uppercase">
        PILOT PREVIEW · НЕ для production · /pilot-investoram
      </div>

      <InvestorHero
        eyebrow="Розділ 04 · інвестиції"
        title="Прямі інвестиції в забудову Львова"
        lead="П'ять проектів у роботі, від $1600/м². Прямий договір з ліцензованим забудовником, без посередницьких ланцюжків."
      >
