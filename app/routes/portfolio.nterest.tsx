          ...
          <div className="lg:col-span-7 space-y-6 text-text-secondary text-base md:text-lg leading-relaxed">
            <FadeIn delay={0.05}>
              <p>
                ...
                міську локацію з продуманою інфраструктурою Львова: пішохідна
                доступність до університетів, офісних кластерів, зупинок
                громадського транспорту. Саме така локація формує стабільний
                орендний попит — що є ключовим для дохідного формату.
              </p>
            </FadeIn>
            <FadeIn delay={0.08}>
              <p>
                ...
                продуктовий формат: компактні квартири для короткострокової та
                довгострокової оренди, зосереджені в одному будинку з єдиним
                управлінням. Монолітно-каркасна технологія забезпечить клас CC3
                за конструктивними характеристиками. Такий формат відповідає
                зростаючому сегменту приватних орендодавців, які хочуть
                керувати активом без операційного навантаження.
              </p>
            </FadeIn>
            <FadeIn delay={0.11}>
              <p>
