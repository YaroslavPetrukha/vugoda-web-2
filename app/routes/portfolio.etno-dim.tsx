          ...
          <div className="lg:col-span-7 space-y-6 text-text-secondary text-base md:text-lg leading-relaxed">
            ...
            <FadeIn delay={0.08}>
              <p>
                ...
                типову панель. Очікуваний формат — середньоповерховий будинок
                (орієнтовно 6–9 поверхів) з невеликою кількістю секцій і
                планувальними рішеннями для сімей від 2 до 4 осіб. Технологія
                будівництва — монолітно-каркасна: вона дає гнучкість у
                плануваннях і надійну конструктиву незалежно від поверховості.
                Для Залізничного району, де переважає стара забудова, подібний
                формат закриває дефіцит нового якісного житла.
              </p>
            </FadeIn>
            <FadeIn delay={0.11}>
              <p>
