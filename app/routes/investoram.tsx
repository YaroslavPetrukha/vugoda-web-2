...
const FAQ_ITEMS = [
  {
    ...
    a: 'ВИГОДА пропонує три формати інвестиційної участі. Перший — купівля майнових прав на квартиру або комерційне приміщення з правом переуступки. Другий — дохідна нерухомість у форматі «дохідний дім» для оренди. Третій — партнерство по проекту: спільне фінансування з індивідуальними умовами і графіком звітності. Всі формати — прямий договір з ПП «ДІК "Вигода +"», ЄДРПОУ 44876801, без посередників.',
  },
  {
    q: 'Як працює угода через майнові права і що підписується?',
    a: 'Договір купівлі-продажу майнових прав укладається до введення будинку в експлуатацію і фіксує: адресу обʼєкта, площу, поверх, секцію, ціну і графік оплати. До підписання інвестор отримує пакет документів забудовника: статут, ЄДРПОУ 44876801, дозвіл на будівництво, технічні умови. Договір передбачає право переуступки — майнові права можна відступити третій особі до здачі будинку.',
  },
  {
    q: 'Яка мінімальна сума інвестиції в ЖК Lakeview?',
    a: 'Мінімальна точка входу — від $1600/м² × 44 м² (однокімнатна), орієнтовно від $70 000. Умови оплати: 30% першого внеску при підписанні, решта — розстрочка до 2027 за погодженим графіком. Конкретна сума залежить від поверху, секції та наявності. Актуальний прайс — на зустрічі або за контактом: 097 990 03 90.',
  },
  {
    q: 'Як переуступити майнові права до здачі будинку?',
    a: 'Переуступка майнових прав — передача прав на обʼєкт від первісного покупця третій особі до введення в експлуатацію. Договір з ПП «ДІК "Вигода +"» (ЄДРПОУ 44876801) передбачає це право для всіх інвесторів. Процедура: підписання договору переуступки між первісним покупцем, новим покупцем і забудовником або нотаріальне оформлення. Деталі і поточні умови — в офісі продажу або у менеджера угоди.',
  },
  {
    q: 'Який очікуваний дохід від інвестиції в нерухомість Lakeview?',
    a: 'Дохідність складається з двох складових: приріст вартості від ціни входу до ринкової ціни після здачі та орендний дохід. Для бізнес-класу у Франківському районі Львова приріст від котловану до здачі становить, за аналітикою ринку 2023–2025 рр., 25–40%. Орендна прибутковість у сегменті — 6–9% річних. Фінансова модель під ваш бюджет — на особистій зустрічі з ВИГОДА.',
  },
  {
    q: 'Які гарантії отримує інвестор і як контролюється будівництво?',
    a: 'Інвестор отримує прямий договір з ПП «ДІК "Вигода +"» (ЄДРПОУ 44876801) з фіксованим предметом угоди і графіком оплати. До підписання — повний пакет документів: статут, дозвіл на будівництво, технічні умови. Впродовж будівництва — помісячний фотозвіт і закріплений менеджер. Передбачена можливість особистого візиту на будмайданчик.',
  },
  {
    q: 'Чи можна вийти з угоди і які умови розірвання?',
    a: 'Умови дострокового розірвання фіксуються в договорі до підписання. Стандартно договір передбачає переуступку прав третій особі — це дозволяє фактично вийти з інвестиції без формального розірвання, зберігаючи приріст вартості. Умови повернення коштів при ініціативі покупця або форс-мажорі — обговорюються на етапі переговорів. Деталі умов виходу рекомендуємо уточнити у ВИГОДА до підписання.',
  },
];
