          ...
          <div className="lg:col-span-7 space-y-6 text-text-secondary text-base md:text-lg leading-relaxed">
            ...
            <FadeIn delay={0.08}>
              <p>
                ...
                юридично чисту угоду. Очікуваний формат: кілька секцій висотою
                до 4–5 поверхів, просторі планування від 2+. Монолітно-каркасна
                технологія тут особливо доречна: вона дозволяє реалізувати
                нестандартні плани без несучих стін усередині квартири.
                Демографія — сімʼї 35–50 років з дітьми або дорослі, які
                переїздять з орендованого у Львові.
              </p>
            </FadeIn>
            <FadeIn delay={0.11}>
              <p>
                ...
                вартість матеріалів, підрядних робіт, інженерних систем.
